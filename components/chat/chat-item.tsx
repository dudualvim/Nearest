...
export const ChatItem = ({
    ...
    const isAdmin = currentProfile.role === MemberRole.ADMIN;
    const isModerator = currentProfile.role === MemberRole.MODERATOR;
                    ...
                    <div className="flex items-center gap-x-2">
                        <div className="flex gap-x-2 items-center">
                            ...
                            {profile.role == MemberRole.MODERATOR && (
                                <Badge variant={"nearest"} >
                                    HOST
                                </Badge>
                            )}
                            {/* <ActionTooltip label={profile.role}>
                    ...
                    {canEditMessage && (
                        <ActionTooltip label="Edit">
                            <Edit
                                ...
                                className="cursor-point ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
                            />
                        </ActionTooltip>
                    )}
